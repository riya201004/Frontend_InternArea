...
function Postinternships() {
  ...
  axios.post("https://internareabackend-8qdv.onrender.com/api/internship",bodyJosn).then((res)=>{
      console.log(res.data)
    }).catch((err)=>
    console.log(err))
    
  }
  alert(t('admin.postInternshipSuccess'))
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div class="mb-10 md:mb-16">
      <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">{t('admin.postInt')}</h2>
    ...
    <form class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2" onSubmit={sendData}>
      ...
      <div class="sm:col-span-2">
        <label for="aboutInternship" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">{t('admin.aboutInt')} <span className="required text-red-800">*</span></label>
      ...
      <div class="sm:col-span-2">
        <label for="stipend" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">{t('intern.stipend')} <span className="required text-red-800">*</span></label>
