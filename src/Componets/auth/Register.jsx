...
<a href="#!" onClick={handleSingin} role="button" class="flex items-center h-9 justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100">
                   ...
                   <h1 class="cursor-pointer px-4 py-3 w-5/6 text-center text-xl text-gray-600 font-bold">{t('register.signInWithGoogle')}</h1>
...
<span className='border-b w-1/5 lg:w1/4'></span>
              ...
              <div className="mt-4">
                <label htmlFor="email" className='border-b text-gray-700 text-sm font-bold mb-2'>{t('navbar.email')}</label>
              ...
              <div className="mt-4">
                <label htmlFor="password" className='border-b text-gray-700 text-sm font-bold mb-2'>{t('navbar.password')}</label>
...
<label htmlFor="Lname" className='border-b text-gray-700 text-sm font-bold mb-2'>{t('register.lname')}</label>
              ...
              <small> {t('register.agree')} <span className='text-blue-400'> {t('register.T&C')}
                </span></small>
                <button className='bg-blue-500 h-9 text-white font-bold py-2 mt-4 px-4 w-full rounded hover:bg-blue-600'> {t('register.signUpButton')}  </button>
                {t('register.alreadyRegistered')} <span className='text-blue-400 cursor-pointer' onClick={showLogin}>{t('navbar.loginButton')} </span> 
</div>
          </div>
        </div>
      </div>
...
<p onClick={handleSingin} className='flex
 items-center h-9 justify-center mt-4 text-white bg-slate-100 rounded-lg hover:bg-gray-100' >
    ...
    <h1 className='text-gray-500'> {t('navbar.loginWithGoogle')}
    </h1>
 </p>
 <div className="mt-4 flex items-center justify-between">
...
<span className='border-b- w-1/5 lg:w-1/4'></span>
 ...
 <div class="mt-4">
             ...
             <div className="mt-4 flex items-center justify-between">
<p className='text-sm'>{t('newToInternarea')}(<span className='text-blue-500 cursor-pointer' onClick={closeLogin}>{t('navbar.studentRegister')}</span>/<span className='text-blue-500 cursor-pointer' onClick={closeLogin}>{t('navbar.companyRegister')}</span>) </p>
             </div>
</div>
                    </div>
                </div>
...
<div className="w-full p-8 lg:w-1/2">
             ...
             <div className="mt-4 flex items-center justify-between">
<p className='text-sm'>{t('navbar.newToInternarea')}(<span className='text-blue-500 cursor-pointer' onClick={closeLogin}>{t('navbar.studentRegister')}</span>/<span className='text-blue-500 cursor-pointer' onClick={closeLogin}>{t('navbar.companyRegister')}</span>) </p>
             </div></div>
             </div>
                </>
            )
