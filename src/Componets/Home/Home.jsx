...
const filterInternShips=internshipData.filter((item)=>
  ...
  return (
    <>
    <LanguageSwitcher />
   <h1 className='text-center text-3xl font-bold'>{t('home.dream')}
</h1>
...
filterInternShips.map(( data,index)=>(
        ...
        <div className="int-1 mt-6 border border-black-500" key={index}>
...
<div className="analytics mt-8 flex flex-wrap justify-center items-center text-center">
    ...
    <span className='font-bold text-6xl text-blue-600'>{t('home.300K+')}</span>
<p>{t('home.companiesHiring')}</p>
    </div>
<div className="text-block mt-5">
    <span className='font-bold text-6xl text-blue-600'>{t('home.10K+')}</span>
    <p>{t('home.newOpenings')}</p>
</div>
<div className="text-block mt-5">
    <span className='font-bold text-6xl text-blue-600'>{t('home.21Mn+')}</span>
    <p>{t('home.activeStudents')}</p>
</div>
<div className="text-block mt-5">
    <span className='font-bold text-6xl text-blue-600'>{t('home.600K+')}</span>
    <p>{t('home.learners')}</p>
</div>
</div>
...
<div className="cont">
<p className="flex justify-center text-white text-xl items-center m-5 w-30">{t('home.empower')}</p>
</div>
